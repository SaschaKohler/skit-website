      ...
      <div className="bg-gray-50 py-16">
        <div className="container mx-auto px-6 max-w-3xl">
          ...
          <div className="bg-white rounded-lg shadow-sm p-8 space-y-6">
            <section>
              <h2 className="text-xl font-semibold mb-4">Informationen über den Diensteanbieter</h2>
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-gray-600">
                  <strong>Tel.:</strong>{" "}
                  <a href="tel:+436509030372" className="text-blue-600 hover:text-blue-800">
                    0650/90 30 372
                  </a>
                </p>
                <p className="text-gray-600">
                  <strong>E-Mail:</strong>{" "}
                  <a href="mailto:office@sascha-kohler.at" className="text-blue-600 hover:text-blue-800">
              ...
              <div>
                ...
                <p className="text-gray-600">Werbeagentur & IT Dienstleistungen</p>
              </div>
            </section>
            ...
            <section className="space-y-4">
              ...
              <div>
                <h3 className="font-semibold mb-2">Aufsichtsbehörde/Gewerbebehörde</h3>
