        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Transparente Preise für Ihren digitalen Erfolg. Alle Pakete beinhalten persönliche Betreuung 
          ...
          <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mb-12 rounded-lg">
            <div className="flex items-start">
              ...
              <div>
                <h3 className="text-lg font-semibold text-blue-800">Wichtiger Hinweis zu unseren Preisen</h3>
                <p className="text-blue-700">
                  Alle angegebenen Preise sind Nettopreise zzgl. der gesetzlichen MwSt. Die endgültigen Kosten 
                  werden individuell nach Ihren spezifischen Anforderungen kalkuliert.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {mainPackages.map((pkg, index) => (
              <div key={index} className="bg-white rounded-xl shadow-md overflow-hidden transition-transform duration-300 hover:shadow-lg">
                <div className="p-8">
          ...
          {/* Zusatzleistungen */}
          <div className="mt-24">
            <h2 className="text-3xl font-bold text-center mb-12">Marketing & SEO Services</h2>
            <div className="grid md:grid-cols-3 gap-8">
              {addOnServices.map((service, index) => (
                <div key={index} className="bg-white rounded-lg shadow-md p-6 transition-transform duration-300 hover:shadow-lg">
          ...
          <div className="mt-16 bg-blue-600 text-white rounded-lg p-8 text-center">
            <h2 className="text-2xl font-bold mb-4">Sind Sie sich noch unsicher?</h2>
            <p className="mb-6 max-w-2xl mx-auto">
              Lassen Sie uns in einem unverbindlichen Gespräch herausfinden, welches Paket am besten zu 
