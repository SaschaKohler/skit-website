...
import { Globe, ShoppingBag, Users, MessageSquare, ArrowRight } from 'lucide-react';
  ...
  const solutions = [
    {
      ...
      description: "Professioneller Webauftritt mit einfacher Content-Verwaltung",
    ...
    },
    {
      ...
      features: ["Zahlungsabwicklung", "Produktkatalog", "Automatisierte Auslieferung"],
