      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Wählen Sie das passende Paket für Ihre Bedürfnisse. Alle Preise sind
        ...
        <div className="text-center mt-12">
          <p className="text-gray-600 mb-6">
            Benötigen Sie ein individuelles Angebot oder haben spezielle
            Anforderungen?
          </p>
          <Link
            to="/packages"
        ...
        <div className="mt-16 p-6 bg-blue-50 rounded-xl text-center">
          <h3 className="text-xl font-semibold mb-3">
            Laufende Kosten transparent
          </h3>
          <p className="text-gray-600">
            Alle Pakete beinhalten im ersten Jahr Hosting und Domain. Die
            laufenden Kosten danach finden Sie in der detaillierten
            Preisübersicht.
          </p>
          <Link
